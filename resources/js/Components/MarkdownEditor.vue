<template>
    <div v-if="editor" class="bg-white rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600">
        <menu class="flex divide-x border-b">
            ...
            <li>
                <button @click="() => editor.chain().focus().toggleCode().run()"
                        type="button"
                        class="px-3 py-2"
                        :class="[editor.isActive('code') ? 'bg-indigo-500 text-white' : 'hover:bg-gray-200',]"
                        title="Code">
